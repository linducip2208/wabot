...
<div class="flex items-center gap-3 mb-5">
    ...
    <div>
        <h1 class="text-xl font-extrabold text-gray-900">Edit Deal</h1>
...
<div class="bg-white rounded-xl border border-gray-200 p-6 max-w-lg">
    <form method="POST" action="{{ route('deals.update', $deal) }}" class="space-y-4">
        ...
        <div class="flex gap-2 pt-1">
            <a href="{{ route('deals.show', $deal) }}" class="flex-1 text-center bg-gray-100 text-gray-700 rounded-xl py-2.5 text-sm font-medium">Batal</a>
