@extends('layouts.app')
@section('title', 'Katalog Baru — WABot')
@section('content')
...
<div class="flex items-center gap-3 mb-5">
    ...
    <div>
        <h1 class="text-xl font-extrabold text-gray-900">Katalog Baru</h1>
        <p class="text-sm text-gray-500 mt-0.5">Buat katalog, lalu tambahkan item produk</p>
    </div>
</div>
...
<div class="bg-white rounded-xl border border-gray-200 p-6 max-w-lg">
    <form method="POST" action="{{ route('catalogs.store') }}" class="space-y-4">
        ...
        <div class="flex gap-2 pt-1">
            <a href="{{ route('catalogs.index') }}" class="flex-1 text-center bg-gray-100 text-gray-700 rounded-xl py-2.5 text-sm font-medium">Batal</a>
