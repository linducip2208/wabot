@extends('layouts.app')
@section('title', 'Edit AI Agent — WABot')
@section('content')
...
<div class="flex items-center gap-3 mb-5">
    ...
    <div>
        <h1 class="text-xl font-extrabold text-gray-900">Edit AI Agent</h1>
        ...
        <div class="grid grid-cols-2 gap-3">
            ...
            <div>
                ...
                <select name="role" class="w-full rounded-xl border border-gray-300 px-3 py-2.5 text-sm">
                    @foreach(['general'=>'Umum','sales'=>'Sales','support'=>'Support','billing'=>'Billing'] as $v=>$l)
