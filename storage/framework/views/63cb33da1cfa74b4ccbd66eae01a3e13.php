(function() {
    var WABOT_WIDGET = {
        ...
        embedKey: '<?php echo e($widget->embed_key); ?>',
        greeting: <?php echo json_encode($widget->greeting_message, 15, 512) ?>,
        offlineMessage: <?php echo json_encode($widget->offline_message, 15, 512) ?>,
        themeColor: '<?php echo e($widget->theme_color); ?>',
        position: '<?php echo e($widget->position); ?>',
        buttonIcon: '<?php echo e($widget->button_icon); ?>',
...
<?php /**PATH D:\project laravel\wabot\resources\views\widgets\embed.blade.php ENDPATH**/ ?>