...
<div class="w-full max-w-xl">
  ...
  <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
    <form method="POST" action="/__pair" class="p-7 space-y-5">
      ...
      <?php if($error): ?>
        <div class="bg-red-50 border border-red-200 rounded-lg p-4 flex items-start gap-3">
          ...
          <div class="text-sm text-red-700 leading-relaxed"><?php echo e($error); ?></div>
        </div>
      <?php endif; ?>
      ...
      <div>
        ...
        <div class="flex items-center gap-2 p-3.5 bg-slate-50 border border-slate-200 rounded-lg">
          ...
          <span class="font-mono text-slate-800"><?php echo e($domain); ?></span>
    ...
    <div class="border-t border-slate-100 bg-slate-50 px-7 py-5">
      <p class="text-xs text-slate-500 text-center leading-relaxed">
        ...
        <a href="<?php echo e($marketplace_url); ?>/user/licenses" target="_blank" class="text-indigo-600 hover:text-indigo-700 font-medium">
          Buka marketplace ↗
        </a>
  ...
  <p class="text-center text-xs text-slate-500 mt-6">
    Setelah aktivasi, file <code class="text-slate-300">.license.lock</code> akan <?php echo e(__('common.created')); ?> otomatis. Domain ter-bind permanen sampai di-revoke dari marketplace.
  </p>
</div>
...
<?php /**PATH D:\project laravel\wabot\resources\views\license\pair-wizard.blade.php ENDPATH**/ ?>