<?php $__env->startSection('title', __('catalogs.create_title')); ?>
...
<div class="flex items-center gap-3 mb-5">
    ...
    <div>
        <h1 class="text-xl font-extrabold text-gray-900"><?php echo e(__('catalogs.heading_create')); ?></h1>
        <p class="text-sm text-gray-500 mt-0.5"><?php echo e(__('catalogs.subtitle_create')); ?></p>
    </div>
</div>

<div class="bg-white rounded-xl border border-gray-200 p-6 max-w-lg">
    <form method="POST" action="<?php echo e(route('catalogs.store')); ?>" class="space-y-4">
        <?php echo csrf_field(); ?>
        <div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <textarea name="description" rows="3" class="w-full rounded-xl border border-gray-300 px-3 py-2.5 text-sm"><?php echo e(old('description')); ?></textarea>
        </div>
        <div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex gap-2 pt-1">
            <a href="<?php echo e(route('catalogs.index')); ?>" class="flex-1 text-center bg-gray-100 text-gray-700 rounded-xl py-2.5 text-sm font-medium"><?php echo e(__('common.cancel')); ?></a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\project laravel\wabot\resources\views\catalogs\create.blade.php ENDPATH**/ ?>