...
<head>
    ...
    <title><?php echo e(__('login.title')); ?> — <?php echo e(config('app.name')); ?></title>
    ...
    <div class="hidden lg:flex relative bg-gradient-to-br from-brand-600 via-brand-800 to-gray-900 p-10 flex-col justify-between overflow-hidden">
        ...
        <div class="relative">
            <a href="/" class="flex items-center gap-2.5 text-white">
                ...
                <span class="font-extrabold text-2xl tracking-tight"><?php echo e(config('app.name')); ?></span>
            </a>
        </div>

        <div class="relative text-white">
            <h2 class="text-5xl font-extrabold leading-tight mb-4"><?php echo e(__('login.hero_tagline')); ?></h2>
            <p class="text-brand-200 text-lg leading-relaxed mb-8 max-w-md"><?php echo e(__('hero.subtitle')); ?></p>
            <div class="grid grid-cols-3 gap-3 max-w-md">
                <div class="bg-white/10 backdrop-blur rounded-xl p-3 text-center">
                    <i class="fas fa-robot text-2xl mb-1 block"></i>
                    <span class="text-xs font-medium"><?php echo e(__('login.hero_benefit1')); ?></span>
                </div>
                <div class="bg-white/10 backdrop-blur rounded-xl p-3 text-center">
                    <i class="fas fa-bullhorn text-2xl mb-1 block"></i>
                    <span class="text-xs font-medium"><?php echo e(__('login.hero_benefit2')); ?></span>
                </div>
                <div class="bg-white/10 backdrop-blur rounded-xl p-3 text-center">
                    <i class="fas fa-comments text-2xl mb-1 block"></i>
                    <span class="text-xs font-medium"><?php echo e(__('login.hero_benefit3')); ?></span>
                </div>
            </div>
        </div>

        <div class="relative text-brand-300/60 text-xs">&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?></div>
    </div>
    ...
    <div class="flex items-center justify-center p-6 lg:p-16">
        <div class="w-full max-w-md">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-4xl font-extrabold text-gray-900"><?php echo e(__('login.title')); ?></h1>
            ...
            <p class="text-gray-500 mb-8"><?php echo e(__('login.no_account')); ?> <a href="<?php echo e(route('register')); ?>" class="text-brand-600 font-semibold hover:underline"><?php echo e(__('login.register_link')); ?></a></p>

            <?php if($errors->any()): ?>
                <div class="mb-4 bg-red-50 border border-red-200 text-red-800 rounded-xl px-4 py-3 text-sm"><?php echo e($errors->first()); ?></div>
            <?php endif; ?>

            <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div>
                    <label class="text-xs font-medium text-gray-600"><?php echo e(__('login.email')); ?></label>
                ...
                <div>
                    <label class="text-xs font-medium text-gray-600"><?php echo e(__('login.password')); ?></label>
                ...
                <button type="submit" class="w-full bg-gradient-to-r from-brand-600 to-brand-700 text-white rounded-xl py-3 font-semibold text-sm hover:shadow-lg hover:shadow-brand-500/25 transition-all">
                    <?php echo e(__('login.submit')); ?> <i class="fas fa-arrow-right ml-1"></i>
                </button>
            </form>

            <div class="mt-6 bg-gray-50 border border-gray-200 rounded-xl p-4">
                <div class="text-xs font-semibold text-gray-700 mb-2 flex items-center gap-1.5"><i class="fas fa-key text-brand-500"></i> <?php echo e(__('login.demo_title')); ?></div>
                <div class="space-y-1 text-xs font-mono text-gray-600">
                    <div><span class="font-bold"><?php echo e(__('login.demo_admin')); ?>:</span> admin@wabot.test / password</div>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH D:\project laravel\wabot\resources\views\auth\login.blade.php ENDPATH**/ ?>