...
class WaRecurring extends Model
{
    protected $fillable = [
        ...
        'facebook_account_id', 'instagram_account_id', 'gbm_account_id',
        'discord_account_id', 'tiktok_account_id', 'line_account_id',
        'twitter_account_id', 'twilio_account_id', 'sendgrid_account_id',
